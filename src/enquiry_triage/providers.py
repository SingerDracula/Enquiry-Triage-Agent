    ...
    def build_payload(self, *, system_prompt: str, email_text: str, response_schema: dict) -> dict:
        ...
        if self.structured_output_mode is StructuredOutputMode.JSON_SCHEMA_STRICT:
            ...
            formatted_system_prompt = (
                ...
                "  Select NORMAL for ordinary questions or complaints without time-sensitive impact. Do not treat "
                "anger alone as URGENT; capital letters or repeated complaints alone also do not make a case URGENT. "
                "Select LOW only for "
                "non-time-sensitive informational requests.\n"
