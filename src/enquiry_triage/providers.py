    ...
    def build_payload(self, *, system_prompt: str, email_text: str, response_schema: dict) -> dict:
        ...
        if self.structured_output_mode is StructuredOutputMode.JSON_SCHEMA_STRICT:
            ...
            formatted_system_prompt = (
                ...
                "  After ruling out URGENT, select LOW when the customer explicitly says 'no rush', 'not urgent', "
                "'whenever convenient', or 'for future reference'. This explicit deferral overrides the NORMAL "
                "default even if a future response would require verification. A claim-status request for future "
                "reference that says 'No rush' is LOW.\n"
                ...
                "  Select LOW also for a clearly optional or general request. Do not use LOW merely because "
